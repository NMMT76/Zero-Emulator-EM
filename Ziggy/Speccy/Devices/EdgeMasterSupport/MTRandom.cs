...
{
	/* 
		Mersenne-Twister implementation by MArcAlx (https://gist.github.com/MarcAlx/3f6164616d5995ae00bf93c2bfb34bbe)
	 */
	/// <summary>
	...
	public class MTRandom
	{
		...
		#region singleton
		private static volatile MTRandom instance;

		private static object syncRoot = new Object();

		public static MTRandom Instance
		{
			get
			{
				if (instance == null)
